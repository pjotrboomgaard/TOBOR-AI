...
class TTSConfig:
    ...
    auto_start_conversations: bool = False
    ...
    def from_config_dict(cls, config_dict: dict) -> 'TTSConfig':
        ...
        return cls(
            ...
            auto_start_conversations=config_dict.get('auto_start_conversations', False),
...
def load_config():
    ...
    result = {
        ...
        "TTS": TTSConfig.from_config_dict({
            ...
            "test_mode": config.getboolean('TTS', 'test_mode', fallback=False),
            "auto_start_conversations": config.getboolean('TTS', 'auto_start_conversations', fallback=False),
        }),
        "CHATUI": {
    ...
    # Add CHARACTERS section if it exists
    if 'CHARACTERS' in config:
        result["CHARACTERS"] = dict(config['CHARACTERS'])
