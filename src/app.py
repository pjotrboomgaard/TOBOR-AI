...
from modules.module_main import initialize_managers, wake_word_callback, utterance_callback, post_utterance_callback, silence_question_callback, start_bt_controller_thread, start_discord_bot, process_discord_message_callback, start_auto_conversation
...
if __name__ == "__main__":
    ...
    try:
        ...
        # If test mode and auto_start_conversations are enabled, start conversation automatically
        if (CONFIG['TTS'].test_mode and 
            CONFIG['TTS'].auto_start_conversations):
